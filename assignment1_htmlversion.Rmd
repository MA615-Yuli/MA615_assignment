...
In this document, I learned how to use tidyverse to handle the dataset and use ggplot to display the graph I need. Also, source is a very powerful function to use R script file in RMD.
